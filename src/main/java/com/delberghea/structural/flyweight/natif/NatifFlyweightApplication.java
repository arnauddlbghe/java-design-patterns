package com.delberghea.structural.flyweight.natif;

import com.delberghea.structural.flyweight.natif.model.Tree;

import java.util.ArrayList;
import java.util.List;

public class NatifFlyweightApplication {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < 1000000; i++) {
            trees.add(new Tree("name", "color", "texture", i, i));
        }
